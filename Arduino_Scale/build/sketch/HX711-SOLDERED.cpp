#line 1 "C:\\Users\\Admin\\Downloads\\Wokwi\\Arduino_Scale\\HX711-SOLDERED.cpp"
/**
 **************************************************
 *
 * @file        HX711.cpp
...
/**
 * @brief       getAverageWeight calculates average weight in grams
 *
 * @param       uint8_t loop number of loops to average
 * @param       uint8_t delay delay between loops
 * @return      float weight in
 */
float HX711::getAverageWeight(uint8_t repeat, uint8_t delay_time)
{
  uint32_t w_avg = 0;
